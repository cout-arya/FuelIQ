...
import { IoFlame, IoEye, IoEyeOff, IoMailOutline, IoLockClosedOutline, IoPersonOutline, IoHardwareChipOutline } from 'react-icons/io5';
...
const Register = () => {
    ...
    return (
        <div className="min-h-screen bg-surface flex">
            ...
            >
                {/* Subtle ambient glow */}
                <div className="absolute top-20 -left-32 w-64 h-64 bg-accent/10 rounded-full blur-[120px] pointer-events-none" />
                ...
                >
                    ...
                    <p className="text-text-secondary text-sm mb-10">
                        Free forever. No paywall surprises.
                    </p>
                </motion.div>
                ...
                >
                    <button className="w-12 h-12 rounded-full bg-surface-2 border border-white/8 flex items-center justify-center hover:bg-surface-3 hover:border-primary/20 transition-all cursor-pointer">
                ...
                >
                    ...
                    Start your journey with ICMR-verified, AI-powered nutrition tracking.
                </motion.p>
            </motion.div>
            ...
            >
                ...
                <motion.div
                    ...
                    className="absolute bottom-24 left-12 bg-surface/80 backdrop-blur-xl rounded-2xl p-5 border border-white/10 shadow-2xl max-w-[260px]"
                >
                    <p className="text-white font-bold text-sm mb-3">Why FuelIQ?</p>
                    {[
                        'ICMR-Verified Indian food data',
                        'Hinglish meal logging',
                ...
                >
                    <IoHardwareChipOutline size={20} className="text-primary" />
